...
- 사건 3 "22:17 — 마지막 리허설" (3인 자유 심문): `/?case=case3`
...
사건 3은 별도 현장·심리전·법정 막 없이 심문 코어만 비교하기 위한 사건이다.
세 용의자를 자유롭게 오가며 질문하고, 증거를 슬롯에 넣어 다음 질문과 함께
정식 제시한다. 주제·전술·심리 수치와 최종 기소·종결 UI는 노출하지 않고,
증거에 따른 방어 단계와 후속 증거 해금만 결정론적으로 처리한다.
